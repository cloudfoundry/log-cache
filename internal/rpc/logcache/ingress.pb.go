...
func init() {
	proto.RegisterType((*SendRequest)(nil), "logcache.SendRequest")
	proto.RegisterType((*SendResponse)(nil), "logcache.SendResponse")
}
...
func (c *ingressClient) Send(ctx context.Context, in *SendRequest, opts ...grpc.CallOption) (*SendResponse, error) {
	...
	err := grpc.Invoke(ctx, "/logcache.Ingress/Send", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Ingress_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/logcache.Ingress/Send",
	}
...
var fileDescriptor1 = []byte{
	...
	,
}
